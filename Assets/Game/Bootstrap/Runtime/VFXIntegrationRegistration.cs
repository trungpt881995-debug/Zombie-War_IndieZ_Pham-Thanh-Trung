...
namespace ZombieWar.Bootstrap
{
    ...
    {
        private readonly GameStateVFXBridge _state; 
        private readonly SoldierDamageVFXBridge _soldier;
        public VFXIntegrationRegistration(GameStateVFXBridge state,SoldierDamageVFXBridge soldier)
        {
            _state=state;
            _soldier=soldier;
        }
