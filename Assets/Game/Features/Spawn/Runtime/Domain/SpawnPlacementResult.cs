namespace ZombieWar.Features.Spawn.Domain
{
    public readonly struct SpawnPlacementResult
    {
        ...
        private SpawnPlacementResult(bool valid, in SpawnPoint point, SpawnRejectReason reason) 
        { 
            IsValid=valid; 
            ResolvedPoint=point; 
            RejectReason=reason; 
        ...
        public static SpawnPlacementResult Rejected(SpawnRejectReason reason) 
        { 
            SpawnPoint p=default; 
            return new SpawnPlacementResult(false,in p,reason); 
        }
    }
}
