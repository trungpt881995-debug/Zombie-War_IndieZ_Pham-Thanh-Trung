...
namespace ZombieWar.Features.UI.Model
{
    public sealed class GameplayHudModel
    {
        ...
        public UIWeaponId SelectedWeapon
        {
            get;
            internal set;
        }
        ...
        internal void SetWeapon(UIWeaponId id, float cooldown, bool interactable)
        {
            _cooldowns[(int) id] = Clamp01(cooldown);
            _interactable[(int) id] = interactable;
        }
