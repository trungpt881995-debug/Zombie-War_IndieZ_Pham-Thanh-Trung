...
namespace ZombieWar.Features.UI.View
{
    ...
    {
        event Action PauseClicked; event Action<UIWeaponId> WeaponClicked;
        void SetScore(long score); void SetGameLevel(int level); void SetSoldierGroupLevel(int level);
