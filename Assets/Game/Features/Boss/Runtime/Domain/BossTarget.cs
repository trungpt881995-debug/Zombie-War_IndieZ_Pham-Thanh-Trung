...
namespace ZombieWar.Features.Boss.Domain
{
    public readonly struct BossTarget
    {
        ...
        public bool IsValid{get;} public EntityId EntityId{get;} public BossPoint Position{get;}
        private BossTarget(bool valid,EntityId id,BossPoint position){IsValid=valid;EntityId=id;Position=position;}
