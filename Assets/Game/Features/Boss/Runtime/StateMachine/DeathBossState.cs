...
namespace ZombieWar.Features.Boss.StateMachine
{
    ...
    public sealed class DeathBossState : IBossState
    {
        ...
        public void Enter()
        {
            ...
            _c.TargetRegistration.Unregister(_c.Model.EntityId);
            _c.Motor.Stop();
            ...
            _c.Feedback.OnDeath(_c.Model.Definition.Id, _c.Model.EntityId, in point);
            // IMPORTANT:
        ...
        private void CompleteAfterAnimation()
        {
            ...
            if (!_defeatPublished)
            {
                _c.EventBus.Publish(new BossDefeatedEvent(_c.Model.Definition.Id, _c.Model.EntityId, _c.Model.LastDamageSource,
                _c.Model.Definition.RewardScore));
                _defeatPublished = true;
            }
            _c.Model.MarkReturnRequested();
            _c.EventBus.Publish(new BossReleasedEvent(_c.Model.Definition.Id, _c.Model.EntityId, BossReleaseReason.Death));
            _c.PoolReturn.Return(_c.Model.EntityId, BossReleaseReason.Death);
        }
        public void Exit()
        {
        }
