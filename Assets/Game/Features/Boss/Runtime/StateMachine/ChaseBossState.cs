        ...
        public void Tick(float dt)
        {
            ...
            if (_decisionRemaining <= 0f)
            {
                ...
                if (_c.TryRefreshOrAcquireTarget(out BossTarget decisionTarget))
                {
                    ...
                    if (BossStateContext.InsideRange(
                            in position,
                            in targetPosition,
                            _c.Model.Definition.AttackRange))
                    {
            ...
            _c.Motor.MoveTowards(
                in destination,
                _c.Model.Definition.MoveSpeed,
                dt);
            ...
            if (_c.Motor is IBossSteeringProvider steeringProvider &&
                steeringProvider.TryGetSteeringTarget(out BossPoint steeringTarget))
            {
            ...
            _c.View.FaceTarget(
                in facingTarget,
                _c.Model.Definition.RotationSpeed,
                dt);
        }
