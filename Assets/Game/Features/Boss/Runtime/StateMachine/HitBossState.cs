...
namespace ZombieWar.Features.Boss.StateMachine
{
    public sealed class HitBossState : IBossState
    {
        ...
        public BossStateId Id => BossStateId.Hit;
        public HitBossState(BossStateContext c)
        {
            _c = c;
        }
        public void Enter()
        {
            ...
            _c.Model.BeginHitReactionCooldown();
            _c.Motor.Stop();
            _c.View.SetLocomotionSpeed(0f);
            _c.View.PlayHit();
            _remaining = _c.Model.Definition.HitReactionDuration;
        }
        ...
        public void Finish()
        {
            if (_c.Model.State == Id) _c.ChangeState(BossStateId.Chase);
        }
        public void Exit()
        {
        }
