...
{
    public readonly struct LevelKillProgressChangedEvent : IEvent
    {
        ...
        public LevelKillProgressChangedEvent(GameLevelId gl, SoldierGroupLevelId sl, int kills, int next)
        {
            GameLevel = gl;
            SoldierGroupLevel = sl;
